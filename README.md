...
In the next POST request, the following configurations must be implemented. 
...
```
The OAuth2 SAML Bearer Assertion Flow can be found in the JavaScript class [simple-SAP-NW-client.js]( https://github.com/ROBROICH/Teams-Chatbot-SAP-NW-Principal-Propagation/blob/master/simple-SAP-NW-client.js)
